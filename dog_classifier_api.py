...
UPLOAD_FOLDER = '/home/ubuntu/Python/Flask/dog_classifier/uploads'
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER

#def init():
global model,graph, dog_names
# load the pre-trained Keras model
model = keras.models.load_model('/home/ubuntu/Python/Flask/dog_classifier/dog_classifier.h5')
model._make_predict_function()
#h5f = h5py.File('dog_labels.h5', 'r')
#dog_names = h5f['dogs'][:]
dog_names = np.load('/home/ubuntu/Python/Flask/dog_classifier/dog_labels.npy')
#h5f.close()
